...
function test()
    ...
    @testset "Helper Functions" begin
        ...
        vol_int_Δ = 43.59822373468517u"kpc*Mpc^2"
        ...
        @test pei_integrand ≈ 2.27034748690E-02u"Mpc^3" rtol=1e-11 # Slightly higher tolerance here, maybe propagation of machine error?
    end
