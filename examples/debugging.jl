...
em = prepare_model_mekal(2.2e20u"cm^-2", energy_range, temperatures=(0.001:0.5:20)u"keV", hydrogen_densities=(1e-20:0.5:10)u"cm^-3", use_interpolation=true)
model = Model_NFW_GNFW(mass, fg, 1.062, 5.4807, 0.3292, 1.156, redshift, [64, 64], pixel_size, em, exposure_time, response, (0u"arcsecondᵃ", 0u"arcsecondᵃ"))
