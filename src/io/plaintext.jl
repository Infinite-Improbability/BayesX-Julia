...
"""
function load_response(data::PlaintextData, min_energy::Unitful.Energy, max_energy::Unitful.Energy)::Tuple{Matrix{<:Unitful.Area{Float64}},Vector{<:Unitful.Energy{Float64}}}
    ...
    return rmf * data.rmf_unit, energy_bins
end
