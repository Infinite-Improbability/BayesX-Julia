...
"""
function load_response(data::PlaintextData, min_energy::Unitful.Energy, max_energy::Unitful.Energy)::Tuple{Matrix{<:Unitful.Area{Float64}},Vector{<:Unitful.Energy{Float64}},NTuple{2,Int64}}
    ...
    energy_bins = collect(range(min_energy, max_energy, length=data.rmf_shape[2]))

    return rmf * data.rmf_unit, energy_bins, (0, 0) # TODO: Update channel range
end
